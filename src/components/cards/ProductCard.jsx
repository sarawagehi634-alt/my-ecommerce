...
const ProductCard = ({ product }) => {
  ...
  const getImageUrl = () => {
    if (!p.image) return "https://via.placeholder.com/300x400?text=No+Image";
    return p.image.startsWith("http") ? p.image : `${import.meta.env.VITE_API_URL || "http://localhost:8000"}/storage/${p.image}`;
  };
