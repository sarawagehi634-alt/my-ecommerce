...
const Button = ({
  ...
  // الحواف (Rounded) في الفاشون يفضل تكون بسيطة (sm) أو حادة جداً لإعطاء فخامة
  const baseStyles =
