...
const DashboardCategories = () => {
  ...
  const handleDelete = async (id) => {
    ...
    const confirmDelete = window.confirm(
      'هل تريد حذف هذا القسم؟ سيؤثر ذلك على المنتجات المرتبطة به.'
    );
    ...
    <div className="p-8 bg-[#fafafa] min-h-screen" dir="rtl">
      ...
      <div className="flex flex-col md:flex-row justify-between items-end mb-8 gap-4">
        ...
        <Link
          ...
          className="flex items-center gap-2 bg-black text-white px-6 py-3 rounded-full hover:bg-gray-800 transition-all shadow-lg"
        >
          <FiPlus strokeWidth={3} />
          <span className="font-bold">إضافة قسم</span>
        </Link>
